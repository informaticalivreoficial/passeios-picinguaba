...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Editar Passeio</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Painel de Controle</a></li>
            <li class="breadcrumb-item"><a href="{{route('passeios.index')}}">Passeios</a></li>
            <li class="breadcrumb-item active">Editar Passeio</li>
        </ol>
    </div>
</div> 
@stop
...
<form action="{{ route('passeios.update', ['id' => $passeio->id]) }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf  
@method('PUT')        
<div class="row">            
<div class="col-12">
            ...
            <div class="col-sm-12 bg-gray-light">                                        
                ...
                <div class="form-group p-3 mb-0">
                    ...
                    <div class="form-check d-inline mx-2">
                        <input id="venda" class="form-check-input" type="checkbox" name="venda" {{ (old('venda') == 'on' || old('venda') == true ? 'checked' : ($passeio->venda == true ? 'checked' : '')) }}>
                        <label for="venda" class="form-check-label">Venda individual</label>
                    </div>
                    <div class="form-check d-inline mx-2">
                        <input id="locacao" class="form-check-input" type="checkbox"  name="locacao" {{ (old('locacao') == 'on' || old('locacao') == true ? 'checked' : ($passeio->locacao == true ? 'checked' : '')) }}>
        ...
        <div class="row mb-4"> 
                    ...
                    <select class="form-control" name="roteiro_id">                        
                        @if (!empty($roteiros) && $roteiros->count() > 0)
                            ...
                            @foreach ($roteiros as $roteiro)
                                <option value="{{$roteiro->id}}" {{ (old('roteiro_id') == $roteiro->id ? 'selected' : ($roteiro->id == $passeio->roteiro_id ? 'selected' : '')) }}> {{$roteiro->name}} </option>
                            @endforeach
                        @else
            ...
            <div class="col-3 col-md-4 col-lg-2">
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value="1" {{ (old('status') == '1' ? 'selected' : ($passeio->status == '1' ? 'selected' : '')) }}>Publicado</option>
                        <option value="0" {{ (old('status') == '0' ? 'selected' : ($passeio->status == '0' ? 'selected' : '')) }}>Rascunho</option>
                    </select>
                </div>
            </div> 
            <div class="col-12 col-sm-6 col-md-4 col-lg-1"> 
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="vagas" value="{{ old('vagas') ?? $passeio->vagas }}">
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-2"> 
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control only-time" data-language='pt-BR' name="saida" value="{{ old('saida') ?? $passeio->saida }}"/>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-2"> 
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control only-time" data-language='pt-BR' name="duracao" value="{{ old('duracao') ?? $passeio->duracao }}"/>
                        <div class="input-group-append">
                            <div class="input-group-text"><i class="fa fa-clock"></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="form-group p-3 mb-1">
                                    <div class="form-check mb-3">
                                        <input id="segunda" class="form-check-input" type="checkbox" name="segunda" {{ (old('segunda') == 'on' || old('segunda') == true ? 'checked' : ($passeio->segunda == true ? 'checked' : '')) }}>
                                        <label for="segunda" class="form-check-label">Segunda</label>
                                    </div> 
                                    <div class="form-check mb-3">
                                        <input id="sexta" class="form-check-input" type="checkbox" name="sexta" {{ (old('sexta') == 'on' || old('sexta') == true ? 'checked' : ($passeio->sexta == true ? 'checked' : '')) }}>
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="form-group p-3 mb-1">
                                    <div class="form-check mb-3">
                                        <input id="terca" class="form-check-input" type="checkbox" name="terca" {{ (old('terca') == 'on' || old('terca') == true ? 'checked' : ($passeio->terca == true ? 'checked' : '')) }}>
                                        <label for="terca" class="form-check-label">Terça</label>
                                    </div>   
                                    <div class="form-check mb-3">
                                        <input id="sabado" class="form-check-input" type="checkbox" name="sabado" {{ (old('sabado') == 'on' || old('sabado') == true ? 'checked' : ($passeio->sabado == true ? 'checked' : '')) }}>
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="form-group p-3 mb-1">
                                    <div class="form-check mb-3">
                                        <input id="quarta" class="form-check-input" type="checkbox" name="quarta" {{ (old('quarta') == 'on' || old('quarta') == true ? 'checked' : ($passeio->quarta == true ? 'checked' : '')) }}>
                                        <label for="quarta" class="form-check-label">Quarta</label>
                                    </div>  
                                    <div class="form-check mb-3">
                                        <input id="domingo" class="form-check-input" type="checkbox" name="domingo" {{ (old('domingo') == 'on' || old('domingo') == true ? 'checked' : ($passeio->domingo == true ? 'checked' : '')) }}>
                            ...
                            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                                <div class="form-group p-3 mb-1">
                                    <div class="form-check mb-2">
                                        <input id="quinta" class="form-check-input" type="checkbox" name="quinta" {{ (old('quinta') == 'on' || old('quinta') == true ? 'checked' : ($passeio->quinta == true ? 'checked' : '')) }}>
                        ...
                        <div class="row mb-2">                           
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="state-dd" class="form-control" name="uf">
                                        @if(!empty($estados))
                                            ...
                                            <option value="{{$estado->estado_id}}" {{ (old('uf') == $estado->estado_id ? 'selected' : ($estado->estado_id == $passeio->uf ? 'selected' : '')) }}>{{$estado->estado_nome}}</option>
                                            @endforeach                                                                        
                                        @endif
                                    </select>
                                </div>
                                        ...
                                        @if(!empty($cidades)))
                                            ...
                                            @foreach($cidades as $cidade)
                                                <option value="{{$cidade->cidade_id}}" 
                                                        {{ (old('cidade') == $cidade->cidade_id ? 'selected' : ($cidade->cidade_id == $passeio->cidade ? 'selected' : '')) }}>{{$cidade->cidade_nome}}</option>                                                                   
                                            @endforeach                                                                        
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-12 col-md-4 col-lg-4"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" title="Bairro" name="bairro" value="{{old('bairro') ?? $passeio->bairro}}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-12 col-md-6 col-lg-5"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" title="Endereço Completo" name="rua" value="{{old('rua') ?? $passeio->rua}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-2"> 
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Número:</b></label>
                                    <input type="text" class="form-control" title="Número do Endereço" name="num" value="{{old('num') ?? $passeio->num}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-3"> 
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Complemento:</b></label>
                                    <input type="text" class="form-control" title="Completo (Opcional)" name="complemento" value="{{old('complemento') ?? $passeio->complemento}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-2"> 
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>CEP:</b></label>
                                    <input type="text" class="form-control mask-zipcode" title="Digite o CEP" name="cep" value="{{old('cep') ?? $passeio->cep}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">                        
                        <div class="row mb-2">
                            <div class="col-12">   
                                ...
                                <textarea id="inputDescription" class="form-control" rows="5" name="notasadicionais">{{ old('notasadicionais') ?? $passeio->notasadicionais }}</textarea>                                                      
                            </div>
                        </div>                                                
                    </div>
                </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-12"> 
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input id="exibivalores_vendasim" class="form-check-input" type="radio" value="1" name="exibivalores_venda" {{(old('exibivalores_venda') == '1' ? 'checked' : ($passeio->exibivalores_venda == '1' ? 'checked' : ''))}}>
                                        <label for="exibivalores_vendasim" class="form-check-label mr-5">Sim</label>
                                        <input id="exibivalores_vendanao" class="form-check-input" type="radio" value="0" name="exibivalores_venda" {{(old('exibivalores_venda') == '0' ? 'checked' : ($passeio->exibivalores_venda == '0' ? 'checked' : ''))}}>
                            ...
                            <div class="col-12 col-md-3 col-lg-3"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mask-money" name="valor_venda" value="{{old('valor_venda') ?? $passeio->valor_venda}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3"> 
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Valor Promocional</b></label>
                                    <input type="text" class="form-control mask-money" name="valor_venda_promocional" value="{{old('valor_venda_promocional') ?? $passeio->valor_venda_promocional}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3"> 
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Criança de 0 a 5 anos</b></label>
                                    <input type="text" class="form-control mask-money" name="valor_v_zerocinco" value="{{old('valor_v_zerocinco') ?? $passeio->valor_v_zerocinco}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3"> 
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Criança de 6 a 12 anos</b></label>
                                    <input type="text" class="form-control mask-money" name="valor_v_seisdoze" value="{{old('valor_v_seisdoze') ?? $passeio->valor_v_seisdoze}}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-12"> 
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Deseja exibir os valores?</b> <small class="text-info">(valores exibidos no layout do cliente)</small></label>
                                    <div class="form-check">
                                        <input id="exibivalores_locacaosim" class="form-check-input" type="radio" value="1" name="exibivalores_locacao" {{(old('exibivalores_locacao') == '1' ? 'checked' : ($passeio->exibivalores_locacao == '1' ? 'checked' : ''))}}>
                                        <label for="exibivalores_locacaosim" class="form-check-label mr-5">Sim</label>
                                        <input id="exibivalores_locacaonao" class="form-check-input" type="radio" value="0" name="exibivalores_locacao" {{(old('exibivalores_locacao') == '0' ? 'checked' : ($passeio->exibivalores_locacao == '0' ? 'checked' : ''))}}>
                            ...
                            <div class="col-12 col-md-3 col-lg-3"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control mask-money" name="valor_locacao" value="{{old('valor_locacao') ?? $passeio->valor_locacao}}">
                                </div>
                            </div>
                            <div class="col-12 col-md-3 col-lg-3"> 
                                <div class="form-group">
                                    <label class="labelforms text-muted"><b>Valor Promocional</b></label>
                                    <input type="text" class="form-control mask-money" name="valor_locacao_promocional" value="{{old('valor_locacao_promocional') ?? $passeio->valor_locacao_promocional}}">
                                </div>
                            </div>                            
                        </div>
                    </div>
