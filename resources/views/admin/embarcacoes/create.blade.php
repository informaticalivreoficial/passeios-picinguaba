...
@section('title', 'Cadastrar Embarcação')
...
<div class="row mb-2">
    <div class="col-sm-6">
        <h1><i class="fas fa-search mr-2"></i>Cadastrar nova Embarcação</h1>
    </div>
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('home')}}">Painel de Controle</a></li>
            <li class="breadcrumb-item"><a href="{{route('embarcacoes.index')}}">Embarcações</a></li>
            <li class="breadcrumb-item active">Cadastrar nova Embarcação</li>
        </ol>
    </div>
</div> 
@stop
...
<form action="{{ route('embarcacoes.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
@csrf          
<div class="row">            
<div class="col-12">
    ...
    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
        ...
        <div class="row mb-2">
            <div class="col-12 col-md-4 col-lg-3"> 
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="passageiros" value="{{ old('passageiros') }}">
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3"> 
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Tripulantes</b> </label>
                    <input type="text" class="form-control" name="tripulantes" value="{{ old('tripulantes') }}">
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3"> 
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Comprimento</b> </label>
                    <input type="text" class="form-control" name="comprimento" value="{{ old('comprimento') }}">
                </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3"> 
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Ano de Construção</b> </label>
                    <input type="text" class="form-control" name="ano_de_construcao" value="{{ old('ano_de_construcao') }}">
                </div>
            </div>
        </div>
        ...
        <div class="row mb-2">
            <div class="col-12">   
                ...
                <x-adminlte-text-editor name="content" v placeholder="Descrição da embarcação..." :config="$config">{{ old('content') }}</x-adminlte-text-editor>                                                                                     
            </div>                       
        </div>
