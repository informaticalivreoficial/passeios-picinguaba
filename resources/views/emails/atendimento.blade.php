...
{{-- Body --}}
    <div style="width:100%; padding:10px;">        
        ...
        <div style="background:#FFF; font:16px Trebuchet MS, Arial, Helvetica, sans-serif; color:#333; line-height:150%;">       
            ...
            <br />
            <strong>Email: </strong><strong style="color:#09F;">{{ $email }}</strong>
            <br />
            <strong>Mensagem: </strong>            
            </p>
            <p style="padding-left:10px;font:16px Trebuchet MS, Arial, Helvetica, sans-serif; color:#09F;">@php echo nl2br($mensagem); @endphp</p>
        </div> 
    </div>
{{-- Footer --}}
@slot('footer')
